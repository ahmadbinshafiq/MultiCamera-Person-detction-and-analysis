...
export default function NoHeatmapfeed() {
  ...
  // const floor_info = location.state.floor_id;
  // const floor_id = '1';

  // get floor_id from localStorage
  const floor_id = localStorage.getItem('floor_id');
  console.log("floor_id from localStorage: ", floor_id);

  // console.log("props for location floor: ", floor_info)
  // console.log("props", location.state.floor_id)
  ...
  React.useEffect(() => {
    const ws = new WebSocket('ws://localhost:8000/ml/map_and_track');
